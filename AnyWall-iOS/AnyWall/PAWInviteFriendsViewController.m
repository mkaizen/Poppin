...
@interface PAWInviteFriendsViewController () <PAWWallViewControllerDelegate,FBSDKAppInviteDialogDelegate,PAWProfileViewControllerDelegate,PAWFriendProfileViewControllerDelegate>
@property (nonatomic, strong) UIButton *noDataButton;
@end

@implementation PAWInviteFriendsViewController
...
- (void)viewDidLoad {
    ...
    self.recentPosts.separatorColor = [UIColor whiteColor];
    ...
    self.recentPosts.allowsMultipleSelection = YES;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FAKFontAwesome *icon = [FAKFontAwesome userIconWithSize:30.0f];
    ...
    cell.imageView.image = [icon imageWithSize:CGSizeMake(40, 40)];
    ...
    [chkBtn setFrame:CGRectMake(0,0, 40, 40)];
    
    [chkBtn setImage:[UIImage imageNamed:@"UNCHECKED@2x.png"]
            forState:UIControlStateNormal];
    [chkBtn setImage:[UIImage imageNamed:@"CHECKED@2x.png"]
    ...
    [chkBtn setTitle:@"I am checked!"
            forState:UIControlStateSelected];
    cell.accessoryView = chkBtn;
    //[cell addSubview:chkBtn];
...
-(void) viewWillDisappear:(BOOL)animated {
    if ([self.navigationController.viewControllers indexOfObject:self]==NSNotFound) {
        ...
        [selectedFriends addObject:[PFUser currentUser]];
        NSArray *selectedIndexPaths = [self.recentPosts indexPathsForSelectedRows];
        
        for(NSIndexPath *index in selectedIndexPaths)
        {
        
            PFUser *friend = [contentList objectAtIndex:index.row];
            [selectedFriends addObject:friend];
            
        }


    [self.delegate addItemViewController:self didFinishEnteringItem:selectedFriends];
    }
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if (buttonIndex == alertView.cancelButtonIndex) {
        // Log out.
        //[PFUser logOut];
        [self.delegate FriendsViewControllerWantsToPresentProfile:self];
